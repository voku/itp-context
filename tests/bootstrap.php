...
require dirname(__DIR__) . '/src/Model/ContextDocument.php';
require dirname(__DIR__) . '/src/Model/ContextQueryResult.php';
require dirname(__DIR__) . '/src/Model/ExportReport.php';
require dirname(__DIR__) . '/src/Model/RuleDef.php';
require dirname(__DIR__) . '/src/Model/RuleTarget.php';
...
require dirname(__DIR__) . '/src/Service/ContextReader.php';
require dirname(__DIR__) . '/src/Service/ContextQuery.php';
